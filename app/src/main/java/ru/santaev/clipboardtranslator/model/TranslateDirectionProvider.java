...
public class TranslateDirectionProvider {
    ...
    private Map<Language, ArrayList<Language>> supportedDirectionsCache = new HashMap<>();
    ...
    public List<Language> getSupportedTargetLanguages(Language origin){
        ...
        for (Language language : Language.values()) {
            if (language != origin && isSupportTranslate(origin, language)){
                res.add(language);
            }
        }
        return res;*/
    ...
    public List<Language> getSupportedOriginLanguages(Language target){
        ...
        ArrayList<Language> res = new ArrayList<>();
        for (Language language : Language.values()) {
            if (language != target && isSupportTranslate(language, target)){
                res.add(language);
            }
        }
        return res;*/

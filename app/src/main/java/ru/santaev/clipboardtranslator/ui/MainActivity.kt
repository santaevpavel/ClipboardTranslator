...
import ru.santaev.clipboardtranslator.ui.MainActivityViewPagerAdapter.Companion.PAGE_HISTORY
import ru.santaev.clipboardtranslator.ui.MainActivityViewPagerAdapter.Companion.PAGE_TRANSLATE
...
class MainActivity : AppCompatActivity(), BottomNavigationView.OnNavigationItemSelectedListener {
        ...
        if (isTablet) {
            ...
            binding.viewPager.addOnPageChangeListener(object : ViewPager.OnPageChangeListener {
                ...
                override fun onPageSelected(position: Int) {
                    when (position) {
                        PAGE_TRANSLATE -> binding.bottomNavigation.menu.findItem(R.id.item_translate).isChecked = true
                        PAGE_HISTORY -> binding.bottomNavigation.menu.findItem(R.id.item_history).isChecked = true
                    }
                }
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            R.id.item_translate -> binding.viewPager.setCurrentItem(PAGE_TRANSLATE, true)
            R.id.item_history -> binding.viewPager.setCurrentItem(PAGE_HISTORY, true)
        }
        return true
    }
